...
- 3以下: その軸について致命的な問題があり、読み手に伝わらない
- 4-5: 明確な弱点がある。指摘なしでは通過が不安なレベル
- 6: 平均的な就活生のES。悪くないが差もつかない
- 7: 弱点が少なく、読み手に引っかかりなく伝わる
- 8: 書類通過ラインを安定して超える完成度。直すなら細部のみ
- 9-10: ほぼ直す点がない。9以上は稀にしか付けない
採点は文章そのものだけを根拠にし、印象で上下させない。同じ文章なら何度採点しても同じ点になるよう、各軸について根拠を1つ思い浮かべてから点を付けること。
