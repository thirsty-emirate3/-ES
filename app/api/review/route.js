...
また、以下の評価軸それぞれを10点満点の整数で採点すること: ${JSON.stringify(AXES[qtype] || AXES["その他"])}

採点ルーブリック(必ずこの基準に従い、絶対評価で採点する):
- 4以下: その軸に致命的な問題があり、読み手に伝わらない(稀にしか付けない)
- 5-6: 明確な弱点があり、直せば大きく良くなる
- 7: 平均的な就活生のES。きちんと書けている
- 8: 弱点が少なく、読み手に引っかかりなく伝わる。書類通過ラインを超える
- 9: 完成度が高い。直すなら細部のみ
- 10: ほぼ直す点がない(稀にしか付けない)
真剣に書かれたESなら多くの軸は7〜8に収まるはず。減点方式ではなく「伝わっているか」の加点方式で見ること。採点は文章そのものだけを根拠にし、同じ文章なら何度採点しても同じ点になるよう、各軸について根拠を1つ思い浮かべてから点を付けること。
