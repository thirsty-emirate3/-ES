...
{"ikkabun":"一文要約。環境/課題/自分の行動/結果の4要素を1文に","kaito30":"30秒回答。サンドイッチ構成(結論→背景と課題→施策2つ→結果)。話し言葉で250字前後","miki":[{"kw":"キーワード(7文字以内)","qs":["この枝について面接官がする質問を3つ。角度を変えて"],"whys":["この枝の核心に対する『なぜ?』の深掘り1段目","その答えをさらに掘る2段目(価値観・再現性・その人らしさを突く)"]}]}
制約:
- mikiは必ず6本。1〜5本目はこのESに固有の深掘りキーワード。
- 6本目は必ず {"kw":"共通質問"} とし、どのESでも聞かれる汎用質問(入社後どう活かすか/最も困難だった点/もう一度やるなら何を変えるか等)をこのESの文脈に寄せて作る。
- 各枝: qsは3問、whysは2段。合計30問。全て質問文のみ(答えは書かない)。`,
      }],
    });
