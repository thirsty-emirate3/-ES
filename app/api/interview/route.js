...
{"ikkabun":"一文要約。環境/課題/自分の行動/結果の4要素を1文に","kaito30":"30秒回答。サンドイッチ構成(結論→背景と課題→施策2つ→結果)。話し言葉で250字前後","miki":[{"kw":"深掘りキーワード(7文字以内の名詞句)","chain":["1段目: このキーワードについて面接官が最初にする素直な質問","2段目: 就活生の想定回答に対して『なぜ?』で一段掘る質問","3段目: さらに本質(価値観・再現性・その人らしさ)を突く質問"]}]}
制約: mikiは4本。chainは必ず3段で、後の段ほど深く鋭くする。Why責めの連鎖として自然につながる質問にすること。`,
      }],
    });
